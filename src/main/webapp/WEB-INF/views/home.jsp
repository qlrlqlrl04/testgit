...
<div class='container'>
	...
	<a href="${pageContext.request.contextPath}/department/dept_list.do"
		class="btn btn-block btn-info">Department List</a>
		
	<a href="${pageContext.request.contextPath}/student/stud_list.do"
		class="btn btn-block btn-warning">Student List</a>
</div>
</body>
</html>
