...
public class ProfessorApi {
	...
	public void ProfessorInsertApi(Locale locale, Model model, HttpServletResponse response) {
		...
		// 파라미터 Beans 구성
		// --> study.spring.hellospring.model.Professor;
		Professor professor = new Professor();
	...
	/** 교수 수정 API */
	@ResponseBody
	@RequestMapping(value = "professor_api/ProfessorUpdateApi", method = RequestMethod.POST)
	public void ProfessorUpdateApi(Locale locale, Model model, HttpServletResponse response) {
